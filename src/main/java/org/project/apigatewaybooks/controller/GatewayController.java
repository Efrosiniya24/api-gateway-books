...
public class GatewayController {
    ...
    public ResponseEntity<String> proxyToBookStorage(@PathVariable String endpoint, @RequestHeader HttpHeaders headers) {
    ...
    public ResponseEntity<String> proxyToBookTracker(@PathVariable String endpoint, @RequestHeader HttpHeaders headers) {
